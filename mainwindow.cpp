...
void getPointP2(double cas_v_minutah, double radijus)
{
    cas_v_minutah = cas_v_minutah / 4;
    cas_v_minutah = cas_v_minutah + 180;
    cas_v_minutah = cas_v_minutah * PI / 180;
...
void MainWindow::paintEvent(QPaintEvent *) {
    ...
    for( int u = 0; u < 24;  u++ ) {
        ...
        getPointP1(u0, radij+1);
        getPointP2(u0, radij+15);
        blackpen.setWidth(3);
        painter.setPen(blackpen);
        painter.drawLine(p1,p2);
        painter.setPen(orangepen);
        painter.drawLine(p1,p2);
        getPointP1(u10, radij+1);
        getPointP2(u10, radij+5);
        blackpen.setWidth(3);
        painter.setPen(blackpen);
        painter.drawLine(p1,p2);
        painter.setPen(orangepen);
        painter.drawLine(p1,p2);
        getPointP1(u20, radij+1);
        getPointP2(u20, radij+5);
        blackpen.setWidth(3);
        painter.setPen(blackpen);
        painter.drawLine(p1,p2);
        painter.setPen(orangepen);
        painter.drawLine(p1,p2);
        getPointP1(u30, radij+1);
        getPointP2(u30, radij+10);
        blackpen.setWidth(3);
        painter.setPen(blackpen);
        painter.drawLine(p1,p2);
        painter.setPen(orangepen);
        painter.drawLine(p1,p2);
        getPointP1(u40, radij+1);
        getPointP2(u40, radij+5);
        blackpen.setWidth(3);
        painter.setPen(blackpen);
        painter.drawLine(p1,p2);
        painter.setPen(orangepen);
        painter.drawLine(p1,p2);
        getPointP1(u50, radij+1);
        getPointP2(u50, radij+5);
        blackpen.setWidth(3);
        painter.setPen(blackpen);
        painter.drawLine(p1,p2);
        painter.setPen(orangepen);
